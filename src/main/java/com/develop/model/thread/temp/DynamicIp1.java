 ...
 * @author 杨尚川
 */
public class DynamicIp1 {
    private DynamicIp1(){}
    private static final Logger LOGGER = LoggerFactory.getLogger(DynamicIp1.class);
